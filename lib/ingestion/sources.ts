...
export const curatedSources: SourceDefinition[] = [
  ...
  {
    id: "src-alibaba-model-studio-releases",
    name: "阿里云百炼模型更新",
    homepageUrl: "https://help.aliyun.com/zh/model-studio/newly-released-models",
    feedUrl: "https://help.aliyun.com/zh/model-studio/newly-released-models",
    sourceType: "official",
    fetchMethod: "html",
    status: "active",
    priority: 18,
    frequencyMinutes: 30,
    allowedHosts: ["help.aliyun.com"],
    authorizationStatus: "approved",
    termsNote: officialHtmlNote,
    robotsNote: htmlRobotsNote,
  },
